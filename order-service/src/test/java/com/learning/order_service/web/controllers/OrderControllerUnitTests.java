...
import static com.learning.order_service.testdata.TestDataFactory.*;
...
class OrderControllerUnitTests {
    ...
    @BeforeEach
    void setUp() {
        given(securityService.getLoginUserName()).willReturn("nidaan");
    }
    ...
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        given(orderService.createOrder(eq("nidaan"), any(CreateOrderRequest.class)))
                .willReturn(null);
